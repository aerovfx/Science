# Bài 24: Điều khiển từ xa bằng radio

> **Câu hỏi lớn:** Cử chỉ ở thiết bị A điều khiển thiết bị B như thế nào?  
> **Sản phẩm:** Bộ điều khiển nghiêng cho servo/LED  
...
1. Giải thích các ý chính: radio group; sender/receiver; mapping; failsafe.
...
hai micro:bit, servo hoặc LED, pin. Chuẩn bị thêm giấy A4, bút, thước, nhật ký kỹ thuật và vật liệu chế tạo nếu cần.
...
**Câu hỏi suy nghĩ:** Điều gì xảy ra khi mất tín hiệu? Hãy thêm trạng thái an toàn sau 2 giây.

## 4. Kiến thức cốt lõi — 15 phút

- Từ khóa: radio group; sender/receiver; mapping; failsafe.
...
```text
sender: tilt left/right → send L/R else S; receiver: on radio set output
```
...
6. **Lưu phiên bản:** đặt tên tệp `Lop_Nhom_Bai24_v1` và chụp sơ đồ kết nối.

### Tiêu chí thành công

- [ ] truyền được ba lệnh trái–dừng–phải trong 10 lần thử.
...
- Phản tư cá nhân 3–5 câu và tên phiên bản cuối `Lop_Nhom_Bai24_final`.
