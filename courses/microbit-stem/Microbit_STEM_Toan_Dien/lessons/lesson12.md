# Bài 12: Cổng logic và hệ thống báo động

> **Câu hỏi lớn:** Nhiều điều kiện phối hợp để tạo quyết định ra sao?  
> **Sản phẩm:** Báo động hai cảm biến  
...
1. Giải thích các ý chính: AND; OR; NOT; bảng chân trị; trạng thái armed.
...
micro:bit, hai nút/cảm biến, buzzer hoặc LED. Chuẩn bị thêm giấy A4, bút, thước, nhật ký kỹ thuật và vật liệu chế tạo nếu cần.
...
**Câu hỏi suy nghĩ:** Lập bảng chân trị trước, sau đó dùng bảng để kiểm thử chương trình.

## 4. Kiến thức cốt lõi — 15 phút

- Từ khóa: AND; OR; NOT; bảng chân trị; trạng thái armed.
...
```text
if armed AND (sensor1 OR sensor2) then alarm else safe
```
...
6. **Lưu phiên bản:** đặt tên tệp `Lop_Nhom_Bai12_v1` và chụp sơ đồ kết nối.

### Tiêu chí thành công

- [ ] kết quả chương trình khớp mọi dòng của bảng chân trị.
...
- Phản tư cá nhân 3–5 câu và tên phiên bản cuối `Lop_Nhom_Bai12_final`.
