...
> **Câu hỏi lớn:** Khi nào nên lặp lệnh thay vì sao chép nhiều lần?  
> **Sản phẩm:** Đèn tín hiệu theo chu kỳ  
...
1. Giải thích các ý chính: repeat; forever; while; biến đếm; điều kiện dừng.
...
**Câu hỏi suy nghĩ:** So sánh repeat và forever: vòng nào kết thúc, vòng nào không?

## 4. Kiến thức cốt lõi — 15 phút

- Từ khóa: repeat; forever; while; biến đếm; điều kiện dừng.
...
```text
forever → show STOP 2 s → show READY 1 s → show GO 3 s
```
...
6. **Lưu phiên bản:** đặt tên tệp `Lop_Nhom_Bai05_v1` và chụp sơ đồ kết nối.

### Tiêu chí thành công

- [ ] chu kỳ chạy ổn định và mã ngắn hơn cách sao chép lệnh.
...
- Phản tư cá nhân 3–5 câu và tên phiên bản cuối `Lop_Nhom_Bai05_final`.
