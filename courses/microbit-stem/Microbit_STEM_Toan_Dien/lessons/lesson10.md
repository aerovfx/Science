# Bài 10: Motor rung và phản hồi xúc giác

> **Câu hỏi lớn:** Có thể truyền thông tin mà không dùng màn hình hoặc âm thanh không?  
> **Sản phẩm:** Thiết bị nhắc việc bằng mẫu rung  
...
1. Giải thích các ý chính: haptic feedback; nhịp; duty cycle; mẫu tín hiệu.
...
micro:bit, motor rung và driver/module phù hợp. Chuẩn bị thêm giấy A4, bút, thước, nhật ký kỹ thuật và vật liệu chế tạo nếu cần.
...
**Câu hỏi suy nghĩ:** Mã hóa ba chữ cái bằng mã Morse rung.

## 4. Kiến thức cốt lõi — 15 phút

- Từ khóa: haptic feedback; nhịp; duty cycle; mẫu tín hiệu.
...
```text
A → short-short-long; B → long-short-long; use pauses between pulses
```
...
6. **Lưu phiên bản:** đặt tên tệp `Lop_Nhom_Bai10_v1` và chụp sơ đồ kết nối.

### Tiêu chí thành công

- [ ] tạo hai mẫu rung mà người dùng phân biệt được khi không nhìn.
...
- Phản tư cá nhân 3–5 câu và tên phiên bản cuối `Lop_Nhom_Bai10_final`.
