# Bài 1: Khám phá micro:bit và Crowtail

> **Câu hỏi lớn:** Một máy tính tí hon nhận, xử lý và phát thông tin như thế nào?  
> **Sản phẩm:** Thẻ tên số có biểu tượng chuyển động  
...
1. Giải thích các ý chính: input – process – output; ma trận LED 5×5; nút A/B; an toàn điện.
...
micro:bit, cáp USB, máy tính, bo mở rộng Crowtail. Chuẩn bị thêm giấy A4, bút, thước, nhật ký kỹ thuật và vật liệu chế tạo nếu cần.
...
**Câu hỏi suy nghĩ:** Kể tên bốn bộ phận trên micro:bit và phân loại chúng thành input hoặc output.

## 4. Kiến thức cốt lõi — 15 phút

- Từ khóa: input – process – output; ma trận LED 5×5; nút A/B; an toàn điện.
...
```text
on start → show icon → scroll name; on button A → show happy; on button B → show heart
```
...
6. **Lưu phiên bản:** đặt tên tệp `Lop_Nhom_Bai01_v1` và chụp sơ đồ kết nối.

### Tiêu chí thành công

- [ ] hiển thị tên, biểu tượng và phản hồi khi nhấn nút.
...
- Phản tư cá nhân 3–5 câu và tên phiên bản cuối `Lop_Nhom_Bai01_final`.
