# Bài 28: Gỡ lỗi có phương pháp

> **Câu hỏi lớn:** Làm sao tìm nguyên nhân thay vì sửa chương trình một cách ngẫu nhiên?  
> **Sản phẩm:** Phòng khám mã lỗi  
...
1. Giải thích các ý chính: lỗi cú pháp; logic; kết nối; logging; test case.
...
micro:bit, chương trình lỗi do giáo viên cung cấp. Chuẩn bị thêm giấy A4, bút, thước, nhật ký kỹ thuật và vật liệu chế tạo nếu cần.
...
**Câu hỏi suy nghĩ:** Tạo một lỗi có chủ đích và viết gợi ý đủ để nhóm khác tự tìm.

## 4. Kiến thức cốt lõi — 15 phút

- Từ khóa: lỗi cú pháp; logic; kết nối; logging; test case.
...
```text
reproduce → isolate → form hypothesis → test one change → verify → record
```
...
6. **Lưu phiên bản:** đặt tên tệp `Lop_Nhom_Bai28_v1` và chụp sơ đồ kết nối.

### Tiêu chí thành công

- [ ] chẩn đoán và sửa ít nhất bốn lỗi, ghi rõ bằng chứng.
...
- Phản tư cá nhân 3–5 câu và tên phiên bản cuối `Lop_Nhom_Bai28_final`.
