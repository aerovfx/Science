# Buổi 16: Dự án bãi đỗ xe RFID

> **Câu hỏi lớn:** Hệ thống kiểm soát đúng thẻ và đúng sức chứa như thế nào?  
> **Sản phẩm:** Barrier RFID có bộ đếm chỗ trống  
...
1. Giải thích: authentication; capacity; invariant; servo barrier; event log.
...
**Thiết bị:** Pico, RC522, servo, LCD/7 đoạn, IR obstacle/reed.
...
**Từ khóa:** authentication; capacity; invariant; servo barrier; event log.
...
5. Lưu phiên bản `Lop_Nhom_Pico_Bai16_v1.py`.

## 7. Thử thách chế tạo — 35 phút

Hoàn thiện **Barrier RFID có bộ đếm chỗ trống**. Sản phẩm phải có chức năng chính, trạng thái chờ, trạng thái lỗi và cách dừng/reset an toàn. Nhóm tự chọn một cải tiến phục vụ người dùng thay vì chỉ trang trí.
...
**Yêu cầu riêng:** thẻ đúng/sai; bãi trống/đầy; quét lặp; xe chưa qua; xe ra.
...
Mã nguồn, bảng chân, ảnh mạch, bảng kiểm thử, ảnh/video demo và phản tư cá nhân. Tên bản cuối: `Lop_Nhom_Pico_Bai16_final.py`.
