# Buổi 8: Joystick và servo SG90

> **Câu hỏi lớn:** Làm sao ánh xạ chuyển động tay thành góc quay mượt?  
> **Sản phẩm:** Đế camera pan điều khiển joystick  
...
1. Giải thích: ADC X/Y; dead zone; map; constrain; servo PWM; jitter.
...
**Thiết bị:** Pico, joystick, SG90, nguồn servo phù hợp.
...
**Từ khóa:** ADC X/Y; dead zone; map; constrain; servo PWM; jitter.
...
5. Lưu phiên bản `Lop_Nhom_Pico_Bai08_v1.py`.

## 7. Thử thách chế tạo — 35 phút

Hoàn thiện **Đế camera pan điều khiển joystick**. Sản phẩm phải có chức năng chính, trạng thái chờ, trạng thái lỗi và cách dừng/reset an toàn. Nhóm tự chọn một cải tiến phục vụ người dùng thay vì chỉ trang trí.
...
**Yêu cầu riêng:** góc 0/90/180; vùng giữa không rung; servo không kẹt cơ khí.
...
Mã nguồn, bảng chân, ảnh mạch, bảng kiểm thử, ảnh/video demo và phản tư cá nhân. Tên bản cuối: `Lop_Nhom_Pico_Bai08_final.py`.
