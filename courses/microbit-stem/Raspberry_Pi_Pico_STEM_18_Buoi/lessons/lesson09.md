# Buổi 9: RFID RC522, IR và khóa cửa thông minh

> **Câu hỏi lớn:** Một hệ thống truy cập xác thực người dùng và xử lý thẻ sai ra sao?  
> **Sản phẩm:** Khóa cửa bằng RFID có quyền quản trị IR  
...
1. Giải thích: SPI; UID; whitelist; IR command; access state; privacy.
...
**Thiết bị:** Pico, RC522, IR receiver/remote, servo, buzzer.
...
**Từ khóa:** SPI; UID; whitelist; IR command; access state; privacy.
...
5. Lưu phiên bản `Lop_Nhom_Pico_Bai09_v1.py`.

## 7. Thử thách chế tạo — 35 phút

Hoàn thiện **Khóa cửa bằng RFID có quyền quản trị IR**. Sản phẩm phải có chức năng chính, trạng thái chờ, trạng thái lỗi và cách dừng/reset an toàn. Nhóm tự chọn một cải tiến phục vụ người dùng thay vì chỉ trang trí.
...
**Yêu cầu riêng:** thẻ hợp lệ, thẻ sai, đọc lặp, mất reader; khóa tự đóng theo thời gian.
...
Mã nguồn, bảng chân, ảnh mạch, bảng kiểm thử, ảnh/video demo và phản tư cá nhân. Tên bản cuối: `Lop_Nhom_Pico_Bai09_final.py`.
