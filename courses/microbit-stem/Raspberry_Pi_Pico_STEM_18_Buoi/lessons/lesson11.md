# Buổi 11: Điều khiển robot bằng joystick

> **Câu hỏi lớn:** Làm sao biến hai trục joystick thành chuyển động tự nhiên?  
> **Sản phẩm:** Xe điều khiển năm trạng thái  
...
1. Giải thích: dead zone; mapping; differential drive; command state.
...
**Thiết bị:** Pico, robot xe, joystick; tùy chọn liên kết có dây/phần cứng không dây phù hợp.
...
**Từ khóa:** dead zone; mapping; differential drive; command state.
...
```python
def command(x,y,low=25000,high=40000):
...
5. Lưu phiên bản `Lop_Nhom_Pico_Bai11_v1.py`.

## 7. Thử thách chế tạo — 35 phút

Hoàn thiện **Xe điều khiển năm trạng thái**. Sản phẩm phải có chức năng chính, trạng thái chờ, trạng thái lỗi và cách dừng/reset an toàn. Nhóm tự chọn một cải tiến phục vụ người dùng thay vì chỉ trang trí.
...
**Yêu cầu riêng:** mỗi lệnh 10 lần; thả joystick phải STOP; đo độ trễ phản hồi.
...
Mã nguồn, bảng chân, ảnh mạch, bảng kiểm thử, ảnh/video demo và phản tư cá nhân. Tên bản cuối: `Lop_Nhom_Pico_Bai11_final.py`.
