# Buổi 17: Dự án xe tự hành tích hợp

> **Câu hỏi lớn:** Làm sao phối hợp nhiều cảm biến mà robot không rơi vào trạng thái mâu thuẫn?  
> **Sản phẩm:** Robot chạy line, tránh vật và báo trạng thái  
...
1. Giải thích: priority; hierarchical state machine; sensor fusion; telemetry; recovery.
...
**Thiết bị:** robot xe, line sensors, HC-SR04, servo, LCD/OLED tùy kit.
...
**Từ khóa:** priority; hierarchical state machine; sensor fusion; telemetry; recovery.
...
```python
# Ưu tiên: EMERGENCY_STOP > OBSTACLE > LINE_FOLLOW > SEARCH
...
5. Lưu phiên bản `Lop_Nhom_Pico_Bai17_v1.py`.

## 7. Thử thách chế tạo — 35 phút

Hoàn thiện **Robot chạy line, tránh vật và báo trạng thái**. Sản phẩm phải có chức năng chính, trạng thái chờ, trạng thái lỗi và cách dừng/reset an toàn. Nhóm tự chọn một cải tiến phục vụ người dùng thay vì chỉ trang trí.
...
**Yêu cầu riêng:** đường chuẩn, vật cản, mất line, sensor lỗi, pin yếu; hoàn thành ba lượt.
...
Mã nguồn, bảng chân, ảnh mạch, bảng kiểm thử, ảnh/video demo và phản tư cá nhân. Tên bản cuối: `Lop_Nhom_Pico_Bai17_final.py`.
