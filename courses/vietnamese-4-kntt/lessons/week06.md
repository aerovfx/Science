# Tuần 6: Bài 10 (Cuộc sống mến yêu) & Bài 11 (Thế giới quanh ta)
# Week 6: Unit 10 (Beloved Life) & Unit 11 (The World Around Us)

## 1. Mục tiêu bài học (Learning Objectives)
### Tiếng Việt (Vietnamese)
- **Đọc hiểu (Reading):** Các bài đọc về vẻ đẹp cuộc sống hằng ngày và sự đa dạng của thế giới tự nhiên (cây cối, con vật)
- **Luyện từ và câu (Vocabulary & Grammar):** Biện pháp tu từ So sánh (A như B) và Nhân hóa (gán đặc điểm, hành động của người cho sự vật)
- **Viết (Writing):** Viết đoạn văn nêu cảm nghĩ về một bài thơ/câu chuyện & bài văn miêu tả cây cối/con vật
- **Nói và nghe (Speaking & Listening):** Chia sẻ về cảnh đẹp thiên nhiên hoặc vật nuôi yêu thích
...
- **Bài học (Lessons):** Bài 10 (Cuộc sống mến yêu) & Bài 11 (Thế giới quanh ta)
- **Phân bổ chương trình:** Dành cho tuần học thứ 6 trong kỳ.
...
| Python Word Frequency Visualizer & Personification Sentence Generator | Practical Application | Applied technology for this week's lesson. |
...
- Phân tích chuyên sâu về: Biện pháp tu từ So sánh (A như B) và Nhân hóa (gán đặc điểm, hành động của người cho sự vật) với nhiều ví dụ thực tiễn trong đời sống hằng ngày. Học sinh cần chú ý cách sử dụng từ ngữ sao cho gợi hình gợi cảm.
...
graph TD;
    ...
    C --> C1[Biện pháp tu từ So sánh (A như B) và Nhân hóa (gán đặc điểm, hành động của người cho sự vật)]
    D --> D1[Viết đoạn văn nêu cảm nghĩ về một bài thơ/câu chuyện & bài văn miêu tả cây cối/con vật]
    E --> E1[Chia sẻ về cảnh đẹp thiên nhiên hoặc vật nuôi yêu thích]
```
...
Bài tập này giúp củng cố kiến thức ngữ pháp, tạo nền tảng vững chắc cho việc viết văn sau này. Cần đặc biệt chú ý đến: Biện pháp tu từ So sánh (A như B) và Nhân hóa (gán đặc điểm, hành động của người cho sự vật)
...
### 💻 Mật mã Python: Python Word Frequency Visualizer & Personification Sentence Generator
Đoạn mã sau đây giúp học sinh lớp 4 ứng dụng lập trình vào ngôn ngữ học:

```python
# ==========================================
# Chương trình Python: Python Word Frequency Visualizer & Personification Sentence Generator
# ==========================================
import re
...
2. **Câu hỏi 2:** Trọng tâm kiến thức (Biện pháp tu từ So sánh (A như B) và Nhân hóa (gán đặc điểm, hành động của người cho sự vật)) trong bài đã giúp ích gì cho việc thể hiện ý tưởng của em?
...
### Đề bài
**Viết đoạn văn nêu cảm nghĩ về một bài thơ/câu chuyện & bài văn miêu tả cây cối/con vật**
