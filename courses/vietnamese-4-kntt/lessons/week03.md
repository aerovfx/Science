# Tuần 3: Bài 5 (Những người sống quanh em) & Bài 6 (Ước mơ của em)

## 🎯 1. Mục Tiêu Bài Học (Learning Objectives)

### Đọc hiểu (Reading)
- **Tiếng Việt:** Rèn luyện kỹ năng đọc to, rõ ràng, diễn cảm các văn bản. Khả năng tìm kiếm thông tin, hiểu ý chính và suy luận từ văn bản: *Các câu chuyện về nghề nghiệp và ước mơ tuổi thơ*.
- **English:** Develop read-aloud fluency and reading comprehension skills. Identify main ideas, extract details, and make inferences from texts related to: *Các câu chuyện về nghề nghiệp và ước mơ tuổi thơ*.

### Luyện từ và câu (Vocabulary & Grammar)
- **Tiếng Việt:** Nắm vững cấu trúc ngữ pháp và từ vựng: *Phân loại câu theo mục đích nói (Câu kể, câu hỏi, câu cảm, câu khiến) và dấu câu*.
- **English:** Master grammar rules and expand vocabulary: *Phân loại câu theo mục đích nói (Câu kể, câu hỏi, câu cảm, câu khiến) và dấu câu*.

### Viết (Writing)
- **Tiếng Việt:** Rèn kỹ năng viết theo đúng thể loại: *Bài văn tả người (Tả ngoại hình, hoạt động, tính tình người thân/thầy cô) & bài viết về nghề nghiệp ước mơ*.
- **English:** Practice writing genres and essay structuring: *Bài văn tả người (Tả ngoại hình, hoạt động, tính tình người thân/thầy cô) & bài viết về nghề nghiệp ước mơ*.

### Nói và nghe (Speaking & Listening)
- **Tiếng Việt:** Tự tin trình bày quan điểm, kể chuyện rõ ràng: *Giới thiệu nghề nghiệp ước mơ của em và lý do lựa chọn*.
- **English:** Speak confidently, practice active listening and storytelling: *Giới thiệu nghề nghiệp ước mơ của em và lý do lựa chọn*.

---

## 📚 2. Liên Kết Sách Giáo Khoa (Textbook Units)
- **Chương trình (Curriculum):** Tiếng Việt 4 - Kết Nối Tri Thức Với Cuộc Sống (Tập 1)
- **Bài học (Lessons):** Tuần 3: Bài 5 (Những người sống quanh em) & Bài 6 (Ước mơ của em)
...
|-----------------|----------------------------------------|----------------------------------|
| Sáng tạo (Creative) | Python Dream Career Survey & Character Description Generator | Hỗ trợ học sinh trực quan hóa ý tưởng và ứng dụng lập trình vào xử lý ngôn ngữ. |
