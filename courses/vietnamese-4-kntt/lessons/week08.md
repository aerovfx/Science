# Tuần 8: Bài 14 (Ngôi nhà chung) & Bài 15 (Hành trình tri thức)
# Week 8: Unit 14 (Our Common Home) & Unit 15 (The Journey of Knowledge)

## 1. Mục tiêu bài học (Learning Objectives)
### Tiếng Việt (Vietnamese)
- **Đọc hiểu (Reading):** Văn bản về bảo vệ Trái Đất, bảo vệ môi trường sống và vẻ đẹp của sách, việc học tập
- **Luyện từ và câu (Vocabulary & Grammar):** Mở rộng vốn từ Môi trường & Tri thức; Trạng ngữ chỉ nguyên nhân (Vì sao?), mục đích (Để làm gì?)
- **Viết (Writing):** Viết đoạn văn/bài văn trình bày ý kiến bảo vệ môi trường & viết bài giới thiệu một cuốn sách em yêu thích (Book Review)
- **Nói và nghe (Speaking & Listening):** Giới thiệu cuốn sách yêu thích trước lớp (tên sách, tác giả, nội dung chính, bài học)
...
- **Bài học (Lessons):** Bài 14 (Ngôi nhà chung) & Bài 15 (Hành trình tri thức)
- **Phân bổ chương trình:** Dành cho tuần học thứ 8 trong kỳ.
...
| Canva Digital Book Review Poster & Python Reading Tracker | Practical Application | Applied technology for this week's lesson. |
...
- Phân tích chuyên sâu về: Mở rộng vốn từ Môi trường & Tri thức; Trạng ngữ chỉ nguyên nhân (Vì sao?), mục đích (Để làm gì?) với nhiều ví dụ thực tiễn trong đời sống hằng ngày. Học sinh cần chú ý cách sử dụng từ ngữ sao cho gợi hình gợi cảm.
...
graph TD;
    ...
    C --> C1[Mở rộng vốn từ Môi trường & Tri thức; Trạng ngữ chỉ nguyên nhân (Vì sao?), mục đích (Để làm gì?)]
    D --> D1[Viết đoạn văn/bài văn trình bày ý kiến bảo vệ môi trường & viết bài giới thiệu một cuốn sách em yêu thích (Book Review)]
    E --> E1[Giới thiệu cuốn sách yêu thích trước lớp (tên sách, tác giả, nội dung chính, bài học)]
```
...
Bài tập này giúp củng cố kiến thức ngữ pháp, tạo nền tảng vững chắc cho việc viết văn sau này. Cần đặc biệt chú ý đến: Mở rộng vốn từ Môi trường & Tri thức; Trạng ngữ chỉ nguyên nhân (Vì sao?), mục đích (Để làm gì?)
...
### 💻 Mật mã Python: Canva Digital Book Review Poster & Python Reading Tracker
Đoạn mã sau đây giúp học sinh lớp 4 ứng dụng lập trình vào ngôn ngữ học:

```python
# ==========================================
# Chương trình Python: Canva Digital Book Review Poster & Python Reading Tracker
# ==========================================
import re
...
2. **Câu hỏi 2:** Trọng tâm kiến thức (Mở rộng vốn từ Môi trường & Tri thức; Trạng ngữ chỉ nguyên nhân (Vì sao?), mục đích (Để làm gì?)) trong bài đã giúp ích gì cho việc thể hiện ý tưởng của em?
...
### Đề bài
**Viết đoạn văn/bài văn trình bày ý kiến bảo vệ môi trường & viết bài giới thiệu một cuốn sách em yêu thích (Book Review)**
