# Tuần 4 / Week 4
## Giai Điệu Đất Nước (Tình Yêu Quê Hương, Đất Nước & Con Người) / Melody of the Country (Love for Homeland, Country & People)

### 1. Mục Tiêu Học Tập / Learning Objectives
**A. Đọc (Reading)**
- [VI] Nắm bắt được nội dung chính, ý nghĩa của các văn bản đọc hiểu. Phân tích được các đặc trưng thể loại: Thơ tự do biểu cảm, truyện ngắn hiện đại khám phá nội tâm nhân vật. Hiểu rõ cách tác giả sử dụng các biện pháp tu từ để làm nổi bật chủ đề Tình yêu đất nước tha thiết, khát vọng cống hiến và sự hòa điệu với thiên nhiên.
- [EN] Understand the main content and meaning of the reading texts. Analyze the genre characteristics: Thơ tự do biểu cảm, truyện ngắn hiện đại khám phá nội tâm nhân vật. Understand clearly how the author uses rhetorical devices to highlight the theme of Tình yêu đất nước tha thiết, khát vọng cống hiến và sự hòa điệu với thiên nhiên.
...
- [VI] Hiểu và vận dụng kiến thức về Ngôn ngữ các vùng miền và Nghĩa của từ ngữ phụ thuộc vào ngữ cảnh cụ thể. Nắm vững các quy tắc ngữ pháp, khả năng kết hợp từ trong câu để tạo ra những cấu trúc sinh động, có giá trị biểu cảm.
- [EN] Understand and apply knowledge of Ngôn ngữ các vùng miền và Nghĩa của từ ngữ phụ thuộc vào ngữ cảnh cụ thể. Master grammar rules, word combination abilities in sentences to create vivid structures with expressive value.
...
**C. Viết (Writing)**
- [VI] Nắm vững cấu trúc và kỹ năng: Viết bài văn biểu cảm về con người hoặc sự việc sử dụng yếu tố miêu tả, tự sự. Hiểu rõ các yêu cầu về hình thức và nội dung của một bài viết chuẩn mực.
- [EN] Master the structure and skills: Viết bài văn biểu cảm về con người hoặc sự việc sử dụng yếu tố miêu tả, tự sự. Clearly understand the formal and content requirements of a standard writing piece.
...
- [VI] Thực hành: Thảo luận nhóm về một vấn đề đời sống áp dụng quy trình làm việc chuyên nghiệp. Tổ chức bài nói khoa học, logic, tạo được sự chú ý với người nghe.
- [EN] Practice: Thảo luận nhóm về một vấn đề đời sống áp dụng quy trình làm việc chuyên nghiệp. Organize the speech scientifically and logically, attracting the listener's attention.
...
- **SGK Kết nối tri thức Ngữ văn 7 Tập 1**: Bài 4 (Giai điệu đất nước)
- **Văn bản đọc hiểu (Reading Texts)**: Mùa xuân nho nhỏ (Thanh Hải), Con muốn làm một cái cây (Võ Thu Hương), Một mình trong mưa
- **Chủ đề xuyên suốt (Cross-cutting Theme)**: Tình yêu đất nước tha thiết, khát vọng cống hiến và sự hòa điệu với thiên nhiên
...
|---|---|---|
| Python (NLP) | Phân tích ngôn ngữ tự nhiên | Thực hành Digital Humanities Lab: Podcast Recording & Voice Sentiment Analysis (Phân tích cảm xúc qua giọng nói) |
...
#### 4.1. Đặc điểm thể loại (Genre Characteristics): Thơ tự do biểu cảm, truyện ngắn hiện đại khám phá nội tâm nhân vật
...
#### 4.2. Kiến thức Tiếng Việt (Linguistic Theory): Ngôn ngữ các vùng miền và Nghĩa của từ ngữ phụ thuộc vào ngữ cảnh cụ thể
...
- [VI] Yêu cầu: Viết bài văn biểu cảm về con người hoặc sự việc sử dụng yếu tố miêu tả, tự sự
...
- [EN] Requirement: Viết bài văn biểu cảm về con người hoặc sự việc sử dụng yếu tố miêu tả, tự sự
...
```text
(Trung tâm: Central Theme) Tình yêu đất nước tha thiết, khát vọng cống hiến và sự hòa điệu với thiên nhiên
...
**Nhiệm vụ (Task)**: Podcast Recording & Voice Sentiment Analysis (Phân tích cảm xúc qua giọng nói)
...
```python
# Digital Humanities Lab: Podcast Recording & Voice Sentiment Analysis (Phân tích cảm xúc qua giọng nói)
# Course: Ngữ văn 7 KNTT - Week 4
...
if __name__ == '__main__':
    print("==========================================================")
    print(f" DIGITAL HUMANITIES LAB - WEEK 4 - TEXT MINING ")
    print("==========================================================")
...
**Câu 1 (Q1)**: [VI] Qua các tác phẩm đọc hiểu trong tuần, em nhận thấy tư tưởng/chủ đề Tình yêu đất nước tha thiết, khát vọng cống hiến và sự hòa điệu với thiên nhiên được thể hiện độc đáo như thế nào? Điểm giống và khác nhau giữa các văn bản là gì?
[EN] Through this week's reading texts, how do you see the theme of Tình yêu đất nước tha thiết, khát vọng cống hiến và sự hòa điệu với thiên nhiên expressed uniquely? What are the similarities and differences between the texts?
...
**Câu 4 (Q4)**: [VI] Dựa vào lý thuyết Tiếng Việt (Ngôn ngữ các vùng miền và Nghĩa của từ ngữ phụ thuộc vào ngữ cảnh cụ thể), hãy viết 3-5 câu tạo thành một đoạn văn ngắn miêu tả một khung cảnh yêu thích, trong đó sử dụng chính xác các yếu tố vừa học.
[EN] Based on the Vietnamese language theory (Ngôn ngữ các vùng miền và Nghĩa của từ ngữ phụ thuộc vào ngữ cảnh cụ thể), write 3-5 sentences forming a short paragraph describing a favorite scene, using the learned elements accurately.
