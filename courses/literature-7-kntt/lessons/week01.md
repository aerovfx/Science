# Tuần 1 / Week 1
## Bầu Trời Tuổi Thơ (Thế Giới Truyện Ngắn & Ký Ức Tuổi Thơ) / Childhood Sky (Short Stories World & Childhood Memories)

### 1. Mục Tiêu Học Tập / Learning Objectives
**A. Đọc (Reading)**
- [VI] Nắm bắt được nội dung chính, ý nghĩa của các văn bản đọc hiểu. Phân tích được các đặc trưng thể loại: Truyện ngắn tuổi thơ, miêu tả thiên nhiên và diễn biến tâm lý tinh tế. Hiểu rõ cách tác giả sử dụng các biện pháp tu từ để làm nổi bật chủ đề Ký ức tuổi thơ, tình anh em, vẻ đẹp thiên nhiên kỳ thú.
- [EN] Understand the main content and meaning of the reading texts. Analyze the genre characteristics: Truyện ngắn tuổi thơ, miêu tả thiên nhiên và diễn biến tâm lý tinh tế. Understand clearly how the author uses rhetorical devices to highlight the theme of Ký ức tuổi thơ, tình anh em, vẻ đẹp thiên nhiên kỳ thú.
...
- [VI] Hiểu và vận dụng kiến thức về Mở rộng trạng ngữ của câu bằng cụm từ (thời gian, địa điểm, nguyên nhân, mục đích). Nắm vững các quy tắc ngữ pháp, khả năng kết hợp từ trong câu để tạo ra những cấu trúc sinh động, có giá trị biểu cảm.
- [EN] Understand and apply knowledge of Mở rộng trạng ngữ của câu bằng cụm từ (thời gian, địa điểm, nguyên nhân, mục đích). Master grammar rules, word combination abilities in sentences to create vivid structures with expressive value.
...
**C. Viết (Writing)**
- [VI] Nắm vững cấu trúc và kỹ năng: Tóm tắt văn bản theo yêu cầu (Quy trình 4 bước tóm tắt ngắn và dài). Hiểu rõ các yêu cầu về hình thức và nội dung của một bài viết chuẩn mực.
- [EN] Master the structure and skills: Tóm tắt văn bản theo yêu cầu (Quy trình 4 bước tóm tắt ngắn và dài). Clearly understand the formal and content requirements of a standard writing piece.
...
- [VI] Thực hành: Kể lại một trải nghiệm đáng nhớ của em với giọng điệu biểu cảm. Tổ chức bài nói khoa học, logic, tạo được sự chú ý với người nghe.
- [EN] Practice: Kể lại một trải nghiệm đáng nhớ của em với giọng điệu biểu cảm. Organize the speech scientifically and logically, attracting the listener's attention.
...
- **SGK Kết nối tri thức Ngữ văn 7 Tập 1**: Bài 1 (Bầu trời tuổi thơ)
- **Văn bản đọc hiểu (Reading Texts)**: Bầy chim chìa vôi (Nguyễn Quang Thiều), Đi lấy mật (Đoàn Giỏi), Ngàn sao làm việc (Võ Quảng)
- **Chủ đề xuyên suốt (Cross-cutting Theme)**: Ký ức tuổi thơ, tình anh em, vẻ đẹp thiên nhiên kỳ thú
...
|---|---|---|
| Python (NLP) | Phân tích ngôn ngữ tự nhiên | Thực hành Digital Humanities Lab: Python Text Summarizer (Tự động trích xuất câu và phân tích tần suất từ khóa) |
...
#### 4.1. Đặc điểm thể loại (Genre Characteristics): Truyện ngắn tuổi thơ, miêu tả thiên nhiên và diễn biến tâm lý tinh tế
...
#### 4.2. Kiến thức Tiếng Việt (Linguistic Theory): Mở rộng trạng ngữ của câu bằng cụm từ (thời gian, địa điểm, nguyên nhân, mục đích)
...
- [VI] Yêu cầu: Tóm tắt văn bản theo yêu cầu (Quy trình 4 bước tóm tắt ngắn và dài)
...
- [EN] Requirement: Tóm tắt văn bản theo yêu cầu (Quy trình 4 bước tóm tắt ngắn và dài)
...
```text
(Trung tâm: Central Theme) Ký ức tuổi thơ, tình anh em, vẻ đẹp thiên nhiên kỳ thú
...
**Nhiệm vụ (Task)**: Python Text Summarizer (Tự động trích xuất câu và phân tích tần suất từ khóa)
...
```python
# Digital Humanities Lab: Python Text Summarizer (Tự động trích xuất câu và phân tích tần suất từ khóa)
# Course: Ngữ văn 7 KNTT - Week 1
...
sample_poem_story = """
Khoảng hai giờ sáng Mon tỉnh giấc. Nó xoay mình sang phía Mên hỏi: - Anh Mên ơi, anh đã ngủ chưa? - Chưa. Mày không ngủ được à? - Vâng. Anh bảo mưa có to không? - Lại chẳng to. Mày có nghe thấy tiếng nước sông kiến lên ầm ầm không?
"""

# Thực thi chương trình (Execute program)
if __name__ == '__main__':
    print("==========================================================")
    print(f" DIGITAL HUMANITIES LAB - WEEK 1 - TEXT MINING ")
    print("==========================================================")
...
**Câu 1 (Q1)**: [VI] Qua các tác phẩm đọc hiểu trong tuần, em nhận thấy tư tưởng/chủ đề Ký ức tuổi thơ, tình anh em, vẻ đẹp thiên nhiên kỳ thú được thể hiện độc đáo như thế nào? Điểm giống và khác nhau giữa các văn bản là gì?
[EN] Through this week's reading texts, how do you see the theme of Ký ức tuổi thơ, tình anh em, vẻ đẹp thiên nhiên kỳ thú expressed uniquely? What are the similarities and differences between the texts?
...
**Câu 4 (Q4)**: [VI] Dựa vào lý thuyết Tiếng Việt (Mở rộng trạng ngữ của câu bằng cụm từ (thời gian, địa điểm, nguyên nhân, mục đích)), hãy viết 3-5 câu tạo thành một đoạn văn ngắn miêu tả một khung cảnh yêu thích, trong đó sử dụng chính xác các yếu tố vừa học.
[EN] Based on the Vietnamese language theory (Mở rộng trạng ngữ của câu bằng cụm từ (thời gian, địa điểm, nguyên nhân, mục đích)), write 3-5 sentences forming a short paragraph describing a favorite scene, using the learned elements accurately.
