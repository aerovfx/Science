...
## Tóm tắt / Summary
**Related SGK KNTT:** Bài 7 (Thế giới viễn tưởng)

### 1. Mục tiêu bài học / Learning Objectives
#### 1.1 Đọc (Reading)
- **VI:** Học sinh hiểu và phân tích được *Cuộc chạm trán trên đại dương*, *Đường vào trung tâm vũ trụ*, *Dấu ấn Hồ Khanh*. Phân tích thể loại Truyện khoa học viễn tưởng.
- **EN:** Students will understand and analyze *Cuộc chạm trán trên đại dương*, *Đường vào trung tâm vũ trụ*, *Dấu ấn Hồ Khanh*. Analyze the genre of Truyện khoa học viễn tưởng.

#### 1.2 Tiếng Việt (Vietnamese Language)
- **VI:** Nắm vững Dấu câu — Công dụng của Dấu chấm lửng (Ellipsis ...).
- **EN:** Master Dấu câu — Công dụng của Dấu chấm lửng (Ellipsis ...).

#### 1.3 Viết (Writing)
- **VI:** Viết bài văn phân tích đặc điểm nhân vật trong tác phẩm văn học.
- **EN:** Practice writing related to the theme.

#### 1.4 Nói và Nghe (Speaking & Listening)
- **VI:** Thảo luận về vai trò của trí tưởng tượng trong cuộc sống và khoa học.
...
|---|---|---|
| Python (NLP) | Phân tích ngôn ngữ / Language Analysis | Sci-Fi Worldbuilding & Coordinate Map Generator |
...
#### Digital Humanities Lab: Sci-Fi Worldbuilding & Coordinate Map Generator
- **Mục tiêu:** Python script dựng bản đồ không gian giả tưởng 2D
...
**Đề bài / Prompt:** Viết bài văn phân tích đặc điểm nhân vật trong tác phẩm văn học
