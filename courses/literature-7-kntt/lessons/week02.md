# Tuần 2 / Week 2
## Khúc Nhạc Tâm Hồn (Thơ 4 Chữ, 5 Chữ & Cảm Xúc Thơ Ca) / Melody of the Soul (4-word, 5-word Poetry & Poetic Emotions)

### 1. Mục Tiêu Học Tập / Learning Objectives
**A. Đọc (Reading)**
- [VI] Nắm bắt được nội dung chính, ý nghĩa của các văn bản đọc hiểu. Phân tích được các đặc trưng thể loại: Thơ 4 chữ, 5 chữ (Vần, nhịp, hình ảnh thơ độc đáo, ngôn ngữ cô đọng). Hiểu rõ cách tác giả sử dụng các biện pháp tu từ để làm nổi bật chủ đề Vẻ đẹp tâm hồn, tình mẹ, quê hương qua lăng kính thơ ca.
- [EN] Understand the main content and meaning of the reading texts. Analyze the genre characteristics: Thơ 4 chữ, 5 chữ (Vần, nhịp, hình ảnh thơ độc đáo, ngôn ngữ cô đọng). Understand clearly how the author uses rhetorical devices to highlight the theme of Vẻ đẹp tâm hồn, tình mẹ, quê hương qua lăng kính thơ ca.
...
- [VI] Hiểu và vận dụng kiến thức về Biện pháp tu từ Ẩn dụ (Metaphor) và Hoán dụ (Metonymy) - Phân tích hiệu quả nghệ thuật. Nắm vững các quy tắc ngữ pháp, khả năng kết hợp từ trong câu để tạo ra những cấu trúc sinh động, có giá trị biểu cảm.
- [EN] Understand and apply knowledge of Biện pháp tu từ Ẩn dụ (Metaphor) và Hoán dụ (Metonymy) - Phân tích hiệu quả nghệ thuật. Master grammar rules, word combination abilities in sentences to create vivid structures with expressive value.
...
**C. Viết (Writing)**
- [VI] Nắm vững cấu trúc và kỹ năng: Viết đoạn văn ghi lại cảm xúc sâu sắc về một bài thơ 4 chữ hoặc 5 chữ. Hiểu rõ các yêu cầu về hình thức và nội dung của một bài viết chuẩn mực.
- [EN] Master the structure and skills: Viết đoạn văn ghi lại cảm xúc sâu sắc về một bài thơ 4 chữ hoặc 5 chữ. Clearly understand the formal and content requirements of a standard writing piece.
...
- [VI] Thực hành: Trình bày cảm xúc về một tác phẩm văn học kết hợp sử dụng slide trực quan. Tổ chức bài nói khoa học, logic, tạo được sự chú ý với người nghe.
- [EN] Practice: Trình bày cảm xúc về một tác phẩm văn học kết hợp sử dụng slide trực quan. Organize the speech scientifically and logically, attracting the listener's attention.
...
- **SGK Kết nối tri thức Ngữ văn 7 Tập 1**: Bài 2 (Khúc nhạc tâm hồn)
- **Văn bản đọc hiểu (Reading Texts)**: Đồng dao mùa xuân (Nguyễn Khoa Điềm), Gặp lá cơm nếp (Thanh Thảo), Trở gió (Nguyễn Ngọc Tư)
- **Chủ đề xuyên suốt (Cross-cutting Theme)**: Vẻ đẹp tâm hồn, tình mẹ, quê hương qua lăng kính thơ ca
...
|---|---|---|
| Python (NLP) | Phân tích ngôn ngữ tự nhiên | Thực hành Digital Humanities Lab: Python Poetry Rhyme & Rhythm Analyzer (Phân tích nhịp điệu và vần thơ) |
...
#### 4.1. Đặc điểm thể loại (Genre Characteristics): Thơ 4 chữ, 5 chữ (Vần, nhịp, hình ảnh thơ độc đáo, ngôn ngữ cô đọng)
...
#### 4.2. Kiến thức Tiếng Việt (Linguistic Theory): Biện pháp tu từ Ẩn dụ (Metaphor) và Hoán dụ (Metonymy) - Phân tích hiệu quả nghệ thuật
...
- [VI] Yêu cầu: Viết đoạn văn ghi lại cảm xúc sâu sắc về một bài thơ 4 chữ hoặc 5 chữ
...
- [EN] Requirement: Viết đoạn văn ghi lại cảm xúc sâu sắc về một bài thơ 4 chữ hoặc 5 chữ
...
```text
(Trung tâm: Central Theme) Vẻ đẹp tâm hồn, tình mẹ, quê hương qua lăng kính thơ ca
...
**Nhiệm vụ (Task)**: Python Poetry Rhyme & Rhythm Analyzer (Phân tích nhịp điệu và vần thơ)
...
```python
# Digital Humanities Lab: Python Poetry Rhyme & Rhythm Analyzer (Phân tích nhịp điệu và vần thơ)
# Course: Ngữ văn 7 KNTT - Week 2
...
sample_poem_story = """
Có một người lính / Đi vào núi xanh / Những năm máu lửa. / Một ngày hòa bình / Anh không về nữa. / Có một người lính / Chưa một lần yêu / Cà phê chưa uống / Còn mê thả diều.
"""

# Thực thi chương trình (Execute program)
if __name__ == '__main__':
    print("==========================================================")
    print(f" DIGITAL HUMANITIES LAB - WEEK 2 - TEXT MINING ")
    print("==========================================================")
...
**Câu 1 (Q1)**: [VI] Qua các tác phẩm đọc hiểu trong tuần, em nhận thấy tư tưởng/chủ đề Vẻ đẹp tâm hồn, tình mẹ, quê hương qua lăng kính thơ ca được thể hiện độc đáo như thế nào? Điểm giống và khác nhau giữa các văn bản là gì?
[EN] Through this week's reading texts, how do you see the theme of Vẻ đẹp tâm hồn, tình mẹ, quê hương qua lăng kính thơ ca expressed uniquely? What are the similarities and differences between the texts?
...
**Câu 4 (Q4)**: [VI] Dựa vào lý thuyết Tiếng Việt (Biện pháp tu từ Ẩn dụ (Metaphor) và Hoán dụ (Metonymy) - Phân tích hiệu quả nghệ thuật), hãy viết 3-5 câu tạo thành một đoạn văn ngắn miêu tả một khung cảnh yêu thích, trong đó sử dụng chính xác các yếu tố vừa học.
[EN] Based on the Vietnamese language theory (Biện pháp tu từ Ẩn dụ (Metaphor) và Hoán dụ (Metonymy) - Phân tích hiệu quả nghệ thuật), write 3-5 sentences forming a short paragraph describing a favorite scene, using the learned elements accurately.
