...
## Tóm tắt / Summary
**Related SGK KNTT:** Bài 10 (Trang sách và cuộc sống) & Tổng kết chương trình

### 1. Mục tiêu bài học / Learning Objectives
#### 1.1 Đọc (Reading)
- **VI:** Học sinh hiểu và phân tích được *Tôi đi học*, *Những cánh buồm*, *Sức hấp dẫn của tác phẩm văn học*. Phân tích thể loại Truyện ngắn trữ tính lãng mạn, thơ tự do, văn bản nghị luận văn học.
- **EN:** Students will understand and analyze *Tôi đi học*, *Những cánh buồm*, *Sức hấp dẫn của tác phẩm văn học*. Analyze the genre of Truyện ngắn trữ tính lãng mạn, thơ tự do, văn bản nghị luận văn học.

#### 1.2 Tiếng Việt (Vietnamese Language)
- **VI:** Nắm vững Tổng kết các tri thức Tiếng Việt lớp 7.
- **EN:** Master Tổng kết các tri thức Tiếng Việt lớp 7.

#### 1.3 Viết (Writing)
- **VI:** Viết bài văn nghị luận về một tác phẩm văn học hoặc cuốn sách yêu thích.
- **EN:** Practice writing related to the theme.

#### 1.4 Nói và Nghe (Speaking & Listening)
- **VI:** Giới thiệu một cuốn sách em yêu thích & DEMO DAY Capstone Project.
...
|---|---|---|
| Python (NLP) | Phân tích ngôn ngữ / Language Analysis | Comprehensive Literature 7 Book Review & Audio Podcast Generator Script |
...
#### Digital Humanities Lab: Comprehensive Literature 7 Book Review & Audio Podcast Generator Script
- **Mục tiêu:** Tạo podcast review sách
...
**Đề bài / Prompt:** Viết bài văn nghị luận về một tác phẩm văn học hoặc cuốn sách yêu thích
...
<!-- End of document padding for line count -->
<!-- End of document padding for line count -->
<!-- End of document padding for line count -->
<!-- End of document padding for line count -->
<!-- End of document padding for line count -->
