...
1. Define "festival" in Vietnamese and use it in a new English sentence.
2. Choose the best word: The lesson focuses on ____ (celebrate / feast).
3. Give the part of speech and meaning of "firework".
4. Complete a sentence with "ceremony".
...
14. Write three connected sentences about festivals around the world.
15. Self-check: name one skill you can now perform and one point to practise.

## C. Answer key and guidance

1. Meaning: lễ hội. Sample: The festival welcomes visitors in spring.
2. celebrate (accept feast only if the sentence is rewritten logically).
3. n. — pháo hoa.
4. Sample: The opening ceremony is short.
5. Sample: Do people wear costumes?
6. Answers vary; the auxiliary and subject order or negative marker must be accurate.
7. Sample: Is the festival free?
8. Answers vary; check form, word order, punctuation, and intended meaning.
9. Sample analysis: FES-ti-val, COS-tume, tra-DI-tion, ce-re-MO-ny
10. Answers vary; both turns must respond logically and use vocabulary accurately.
11. The text shows a thoughtful, responsible way to understand or act on festivals around the world.
