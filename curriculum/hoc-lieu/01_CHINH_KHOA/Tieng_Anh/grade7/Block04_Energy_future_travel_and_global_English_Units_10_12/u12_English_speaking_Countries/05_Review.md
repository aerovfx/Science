...
1. Define "country" in Vietnamese and use it in a new English sentence.
2. Choose the best word: The lesson focuses on ____ (capital / native).
3. Give the part of speech and meaning of "multicultural".
4. Complete a sentence with "landscape".
...
14. Write three connected sentences about english-speaking countries.
15. Self-check: name one skill you can now perform and one point to practise.

## C. Answer key and guidance

1. Meaning: quốc gia. Sample: Canada is a large country.
2. capital (accept native only if the sentence is rewritten logically).
3. adj. — đa văn hoá.
4. Sample: The mountain landscape is dramatic.
5. Sample: We visited a university.
6. Answers vary; the auxiliary and subject order or negative marker must be accurate.
7. Sample: Ottawa is the capital of Canada.
8. Answers vary; check form, word order, punctuation, and intended meaning.
9. Sample analysis: a /ə/ city, an /ən/ island, the /ðə/ coast, the /ðiː/ ocean
10. Answers vary; both turns must respond logically and use vocabulary accurately.
11. The text shows a thoughtful, responsible way to understand or act on english-speaking countries.
