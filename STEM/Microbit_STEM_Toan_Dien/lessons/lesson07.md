# Bài 7: Buzzer và âm thanh

> **Câu hỏi lớn:** Dữ liệu số tạo ra âm thanh và nhịp điệu như thế nào?  
> **Sản phẩm:** Chuông cửa có hai giai điệu  
...
1. Giải thích các ý chính: tần số; cao độ; trường độ; nhịp; output.
...
micro:bit, bo Crowtail, buzzer, cáp nối. Chuẩn bị thêm giấy A4, bút, thước, nhật ký kỹ thuật và vật liệu chế tạo nếu cần.
...
**Câu hỏi suy nghĩ:** Thiết kế một mẫu âm báo thành công và một mẫu âm cảnh báo.

## 4. Kiến thức cốt lõi — 15 phút

- Từ khóa: tần số; cao độ; trường độ; nhịp; output.
...
```text
A → play C-E-G; B → play G-E-C; A+B → stop all sounds
```
...
6. **Lưu phiên bản:** đặt tên tệp `Lop_Nhom_Bai07_v1` và chụp sơ đồ kết nối.

### Tiêu chí thành công

- [ ] A và B phát hai tín hiệu khác nhau, âm dừng đúng lúc.
...
- Phản tư cá nhân 3–5 câu và tên phiên bản cuối `Lop_Nhom_Bai07_final`.
