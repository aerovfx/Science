# Bài 34: Dự án hệ thống chống trộm

> **Câu hỏi lớn:** Làm sao phát hiện xâm nhập nhưng hạn chế báo động giả?  
> **Sản phẩm:** Báo động có bật/tắt và cảnh báo từ xa  
...
1. Giải thích các ý chính: armed state; delay; sensor fusion; event log.
...
hai micro:bit tùy chọn, magnetic/touch sensor, buzzer, radio. Chuẩn bị thêm giấy A4, bút, thước, nhật ký kỹ thuật và vật liệu chế tạo nếu cần.
...
**Câu hỏi suy nghĩ:** Thêm mã PIN, xác nhận gói radio và nhật ký thời gian.

## 4. Kiến thức cốt lõi — 15 phút

- Từ khóa: armed state; delay; sensor fusion; event log.
...
```text
arm with code; entry delay; if armed AND intrusion → alarm + radio; log event
```
...
6. **Lưu phiên bản:** đặt tên tệp `Lop_Nhom_Bai34_v1` và chụp sơ đồ kết nối.

### Tiêu chí thành công

- [ ] vượt qua ít nhất 8 kịch bản gồm bình thường, xâm nhập và lỗi cảm biến.
...
- Phản tư cá nhân 3–5 câu và tên phiên bản cuối `Lop_Nhom_Bai34_final`.
