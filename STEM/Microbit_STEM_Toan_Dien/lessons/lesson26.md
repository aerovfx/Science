# Bài 26: Mini IoT và dữ liệu serial

> **Câu hỏi lớn:** Làm sao đóng gói dữ liệu thiết bị để máy tính quan sát được?  
> **Sản phẩm:** Trạm ghi dữ liệu nhiệt độ/ánh sáng  
...
1. Giải thích các ý chính: lấy mẫu; timestamp; CSV/JSON; serial; quyền riêng tư.
...
micro:bit, cáp USB, máy tính. Chuẩn bị thêm giấy A4, bút, thước, nhật ký kỹ thuật và vật liệu chế tạo nếu cần.
...
**Câu hỏi suy nghĩ:** Vẽ biểu đồ và tìm một giá trị bất thường; không ghi thông tin cá nhân.

## 4. Kiến thức cốt lõi — 15 phút

- Từ khóa: lấy mẫu; timestamp; CSV/JSON; serial; quyền riêng tư.
...
```text
every 2 s → read temp/light → serial write timestamp,value,unit
```
...
6. **Lưu phiên bản:** đặt tên tệp `Lop_Nhom_Bai26_v1` và chụp sơ đồ kết nối.

### Tiêu chí thành công

- [ ] xuất ít nhất 20 dòng dữ liệu có nhãn và khoảng lấy mẫu ổn định.
...
- Phản tư cá nhân 3–5 câu và tên phiên bản cuối `Lop_Nhom_Bai26_final`.
