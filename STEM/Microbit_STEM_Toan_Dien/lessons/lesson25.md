# Bài 25: Phát triển trò chơi kéo–búa–bao

> **Câu hỏi lớn:** Làm sao chuyển luật chơi thành trạng thái và thuật toán?  
> **Sản phẩm:** Trò chơi kéo–búa–bao có tính điểm  
...
1. Giải thích các ý chính: random; state; event; luật thắng; biến điểm.
...
micro:bit, cáp USB; tùy chọn hai micro:bit. Chuẩn bị thêm giấy A4, bút, thước, nhật ký kỹ thuật và vật liệu chế tạo nếu cần.
...
**Câu hỏi suy nghĩ:** Thu thập 30 kết quả để xem bộ sinh ngẫu nhiên có tương đối cân bằng không.

## 4. Kiến thức cốt lõi — 15 phút

- Từ khóa: random; state; event; luật thắng; biến điểm.
...
```text
on shake → choice=random 0..2 → display; compare player and computer → update score
```
...
6. **Lưu phiên bản:** đặt tên tệp `Lop_Nhom_Bai25_v1` và chụp sơ đồ kết nối.

### Tiêu chí thành công

- [ ] chơi được 10 lượt và cộng điểm đúng mọi trường hợp.
...
- Phản tư cá nhân 3–5 câu và tên phiên bản cuối `Lop_Nhom_Bai25_final`.
