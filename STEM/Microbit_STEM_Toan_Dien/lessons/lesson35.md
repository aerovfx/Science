# Bài 35: Thiết kế sản phẩm cuối khóa

> **Câu hỏi lớn:** Làm sao biến một nhu cầu thật thành giải pháp có thể kiểm chứng?  
> **Sản phẩm:** Hồ sơ thiết kế và nguyên mẫu phiên bản 1  
...
1. Giải thích các ý chính: design thinking; tiêu chí; ràng buộc; ma trận lựa chọn; rủi ro.
...
micro:bit và module theo dự án, vật liệu chế tạo. Chuẩn bị thêm giấy A4, bút, thước, nhật ký kỹ thuật và vật liệu chế tạo nếu cần.
...
**Câu hỏi suy nghĩ:** Phỏng vấn hai người dùng và dùng phản hồi để thay đổi ít nhất một quyết định.

## 4. Kiến thức cốt lõi — 15 phút

- Từ khóa: design thinking; tiêu chí; ràng buộc; ma trận lựa chọn; rủi ro.
...
```text
identify → research → ideate → select → prototype → test
```
...
6. **Lưu phiên bản:** đặt tên tệp `Lop_Nhom_Bai35_v1` và chụp sơ đồ kết nối.

### Tiêu chí thành công

- [ ] có vấn đề rõ, ≥3 tiêu chí, ≥2 phương án, sơ đồ, pseudocode và kế hoạch test.
...
- Phản tư cá nhân 3–5 câu và tên phiên bản cuối `Lop_Nhom_Bai35_final`.
