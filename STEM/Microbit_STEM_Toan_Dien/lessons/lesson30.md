# Bài 30: Dự án trạm thời tiết

> **Câu hỏi lớn:** Dữ liệu môi trường nào giúp chúng ta ra quyết định hằng ngày?  
> **Sản phẩm:** Trạm nhiệt độ và ánh sáng có cảnh báo  
...
1. Giải thích các ý chính: đo; lấy mẫu; hiệu chuẩn; ghi dữ liệu; biểu đồ.
...
micro:bit; cảm biến tích hợp hoặc module; máy tính. Chuẩn bị thêm giấy A4, bút, thước, nhật ký kỹ thuật và vật liệu chế tạo nếu cần.
...
**Câu hỏi suy nghĩ:** Dùng radio gửi dữ liệu từ trạm ngoài trời đến trạm hiển thị.

## 4. Kiến thức cốt lõi — 15 phút

- Từ khóa: đo; lấy mẫu; hiệu chuẩn; ghi dữ liệu; biểu đồ.
...
```text
every interval read sensors → store/send → compare thresholds → display status
```
...
6. **Lưu phiên bản:** đặt tên tệp `Lop_Nhom_Bai30_v1` và chụp sơ đồ kết nối.

### Tiêu chí thành công

- [ ] thu ít nhất 20 mẫu, hiển thị trạng thái và giải thích một xu hướng.
...
- Phản tư cá nhân 3–5 câu và tên phiên bản cuối `Lop_Nhom_Bai30_final`.
