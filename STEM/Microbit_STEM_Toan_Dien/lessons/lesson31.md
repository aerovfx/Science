# Bài 31: Dự án bãi đỗ xe thông minh

> **Câu hỏi lớn:** Hệ thống nhận biết xe và vận hành thanh chắn an toàn thế nào?  
> **Sản phẩm:** Mô hình bãi xe có thanh chắn và đèn trạng thái  
...
1. Giải thích các ý chính: khoảng cách; state machine; servo; an toàn cơ khí.
...
micro:bit, ultrasonic, servo, RGB LED, bìa. Chuẩn bị thêm giấy A4, bút, thước, nhật ký kỹ thuật và vật liệu chế tạo nếu cần.
...
**Câu hỏi suy nghĩ:** Thêm bộ đếm sức chứa và biển FULL.

## 4. Kiến thức cốt lõi — 15 phút

- Từ khóa: khoảng cách; state machine; servo; an toàn cơ khí.
...
```text
if car approaching AND gate closed → open; wait until clear → close; update capacity
```
...
6. **Lưu phiên bản:** đặt tên tệp `Lop_Nhom_Bai31_v1` và chụp sơ đồ kết nối.

### Tiêu chí thành công

- [ ] nhận xe và đóng/mở đúng ít nhất 9/10 lượt, không đóng khi xe ở dưới chắn.
...
- Phản tư cá nhân 3–5 câu và tên phiên bản cuối `Lop_Nhom_Bai31_final`.
