# Bài 33: Dự án tưới cây thông minh

> **Câu hỏi lớn:** Làm sao tưới đủ nước nhưng không lãng phí?  
> **Sản phẩm:** Hệ thống tưới theo độ ẩm đất  
...
1. Giải thích các ý chính: hiệu chuẩn; hysteresis; giới hạn thời gian; an toàn nước–điện.
...
micro:bit, soil sensor, driver/relay, bơm điện áp thấp, khay chống nước. Chuẩn bị thêm giấy A4, bút, thước, nhật ký kỹ thuật và vật liệu chế tạo nếu cần.
...
**Câu hỏi suy nghĩ:** Tính lượng nước dùng và đề xuất cách giảm ít nhất 20%.

## 4. Kiến thức cốt lõi — 15 phút

- Từ khóa: hiệu chuẩn; hysteresis; giới hạn thời gian; an toàn nước–điện.
...
```text
if moisture<LOW and tankOK → pump on; if moisture>HIGH or timeout → pump off
```
...
6. **Lưu phiên bản:** đặt tên tệp `Lop_Nhom_Bai33_v1` và chụp sơ đồ kết nối.

### Tiêu chí thành công

- [ ] có ngưỡng khô/ướt từ dữ liệu và bơm dừng theo điều kiện an toàn.
...
- Phản tư cá nhân 3–5 câu và tên phiên bản cuối `Lop_Nhom_Bai33_final`.
