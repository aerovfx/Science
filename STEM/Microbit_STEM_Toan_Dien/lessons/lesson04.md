...
> **Câu hỏi lớn:** Thiết bị ra quyết định dựa vào dữ liệu như thế nào?  
> **Sản phẩm:** Huy hiệu trạng thái ba mức  
...
1. Giải thích các ý chính: Boolean; so sánh; if/else-if/else; nhánh chương trình.
...
**Câu hỏi suy nghĩ:** Lập bảng gồm các giá trị 0, 2, 3, 6, 7, 10 và kết quả dự kiến.

## 4. Kiến thức cốt lõi — 15 phút

- Từ khóa: Boolean; so sánh; if/else-if/else; nhánh chương trình.
...
```text
if level<3 show SAD; else if level<7 show MEH; else show HAPPY
```
...
6. **Lưu phiên bản:** đặt tên tệp `Lop_Nhom_Bai04_v1` và chụp sơ đồ kết nối.

### Tiêu chí thành công

- [ ] hiển thị đúng ba trạng thái thấp, vừa, cao theo giá trị biến.
...
- Phản tư cá nhân 3–5 câu và tên phiên bản cuối `Lop_Nhom_Bai04_final`.
