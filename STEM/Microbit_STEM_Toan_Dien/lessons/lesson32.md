# Bài 32: Dự án robot tránh vật cản

> **Câu hỏi lớn:** Robot tự chọn hướng dựa vào khoảng cách như thế nào?  
> **Sản phẩm:** Robot hoàn thành đường thử  
...
1. Giải thích các ý chính: feedback; threshold; state; chiến lược điều hướng.
...
micro:bit, khung xe/motor driver hoặc mô hình servo, ultrasonic. Chuẩn bị thêm giấy A4, bút, thước, nhật ký kỹ thuật và vật liệu chế tạo nếu cần.
...
**Câu hỏi suy nghĩ:** So sánh chiến lược luôn rẽ phải với rẽ theo phía có khoảng trống.

## 4. Kiến thức cốt lõi — 15 phút

- Từ khóa: feedback; threshold; state; chiến lược điều hướng.
...
```text
read distance; if safe move forward else stop → reverse → turn → retry
```
...
6. **Lưu phiên bản:** đặt tên tệp `Lop_Nhom_Bai32_v1` và chụp sơ đồ kết nối.

### Tiêu chí thành công

- [ ] hoàn thành đường thử ba lần mà không va chạm.
...
- Phản tư cá nhân 3–5 câu và tên phiên bản cuối `Lop_Nhom_Bai32_final`.
