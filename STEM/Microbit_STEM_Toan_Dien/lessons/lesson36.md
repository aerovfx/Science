# Bài 36: Demo và bảo vệ dự án

> **Câu hỏi lớn:** Bằng chứng nào cho thấy giải pháp có giá trị và đáng tin cậy?  
> **Sản phẩm:** Sản phẩm hoàn thiện, hồ sơ và bài bảo vệ  
...
1. Giải thích các ý chính: verification; iteration; evidence; communication; reflection.
...
nguyên mẫu, mã nguồn, poster/slide, dữ liệu kiểm thử. Chuẩn bị thêm giấy A4, bút, thước, nhật ký kỹ thuật và vật liệu chế tạo nếu cần.
...
**Câu hỏi suy nghĩ:** Nêu trung thực một giới hạn và đề xuất phiên bản tiếp theo khả thi.

## 4. Kiến thức cốt lõi — 15 phút

- Từ khóa: verification; iteration; evidence; communication; reflection.
...
```text
run tests → fix highest-impact issue → rehearse demo → present evidence → reflect
```
...
6. **Lưu phiên bản:** đặt tên tệp `Lop_Nhom_Bai36_v1` và chụp sơ đồ kết nối.

### Tiêu chí thành công

- [ ] nộp đủ hồ sơ, có ≥5 test case, cải tiến dựa dữ liệu và demo ổn định.
...
- Phản tư cá nhân 3–5 câu và tên phiên bản cuối `Lop_Nhom_Bai36_final`.
