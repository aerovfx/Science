# Bài 2: Điều khiển ma trận LED

> **Câu hỏi lớn:** Làm sao biểu diễn thông tin bằng chỉ 25 điểm sáng?  
> **Sản phẩm:** Biển báo có hoạt ảnh ba khung hình  
...
1. Giải thích các ý chính: tọa độ x–y; pixel; trạng thái bật/tắt; trình tự; thời gian dừng.
...
micro:bit, cáp USB, giấy ô vuông 5×5. Chuẩn bị thêm giấy A4, bút, thước, nhật ký kỹ thuật và vật liệu chế tạo nếu cần.
...
**Câu hỏi suy nghĩ:** Vẽ trước ba khung trên giấy và dự đoán chuyển động trước khi lập trình.

## 4. Kiến thức cốt lõi — 15 phút

- Từ khóa: tọa độ x–y; pixel; trạng thái bật/tắt; trình tự; thời gian dừng.
...
```text
on start → repeat 3 times → show frame 1 → pause → show frame 2 → pause → show frame 3
```
...
6. **Lưu phiên bản:** đặt tên tệp `Lop_Nhom_Bai02_v1` và chụp sơ đồ kết nối.

### Tiêu chí thành công

- [ ] hoạt ảnh có ít nhất ba khung, chạy đúng thứ tự và dễ nhận biết.
...
- Phản tư cá nhân 3–5 câu và tên phiên bản cuối `Lop_Nhom_Bai02_final`.
