# Bài 6: Hàm và phân rã bài toán

> **Câu hỏi lớn:** Làm sao viết chương trình dễ đọc, dễ sửa và tái sử dụng?  
> **Sản phẩm:** Thư viện hiệu ứng LED  
...
1. Giải thích các ý chính: hàm; tên hàm; tham số; gọi hàm; phân rã.
...
**Câu hỏi suy nghĩ:** Nếu muốn đổi tốc độ toàn bộ hiệu ứng, dùng tham số giúp ích thế nào?

## 4. Kiến thức cốt lõi — 15 phút

- Từ khóa: hàm; tên hàm; tham số; gọi hàm; phân rã.
...
```text
define blink(times, speed); define celebrate(); A → blink(3,200); B → celebrate()
```
...
6. **Lưu phiên bản:** đặt tên tệp `Lop_Nhom_Bai06_v1` và chụp sơ đồ kết nối.

### Tiêu chí thành công

- [ ] có ít nhất hai hàm, mỗi hàm được gọi từ hai vị trí.
...
- Phản tư cá nhân 3–5 câu và tên phiên bản cuối `Lop_Nhom_Bai06_final`.
