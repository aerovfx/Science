# Bài 11: Cảm biến chạm

> **Câu hỏi lớn:** Cơ thể người trở thành một đầu vào điện tử như thế nào?  
> **Sản phẩm:** Bảng điều khiển cảm ứng ba chức năng  
...
1. Giải thích các ý chính: điện dung; sự kiện chạm; debounce; trạng thái.
...
micro:bit, dây kẹp cá sấu hoặc touch module. Chuẩn bị thêm giấy A4, bút, thước, nhật ký kỹ thuật và vật liệu chế tạo nếu cần.
...
**Câu hỏi suy nghĩ:** Thiết kế chuỗi mật mã ba lần chạm để mở khóa.

## 4. Kiến thức cốt lõi — 15 phút

- Từ khóa: điện dung; sự kiện chạm; debounce; trạng thái.
...
```text
touch P0 → icon; touch P1 → sound; touch P2 → change mode; wait 200 ms
```
...
6. **Lưu phiên bản:** đặt tên tệp `Lop_Nhom_Bai11_v1` và chụp sơ đồ kết nối.

### Tiêu chí thành công

- [ ] ba vùng chạm tạo ba phản hồi, không tự kích hoạt liên tục.
...
- Phản tư cá nhân 3–5 câu và tên phiên bản cuối `Lop_Nhom_Bai11_final`.
