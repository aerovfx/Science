# Bài 8: Servo và cửa tự động

> **Câu hỏi lớn:** Làm sao điều khiển chính xác góc quay của một cơ cấu?  
> **Sản phẩm:** Mô hình cửa tự động  
...
1. Giải thích các ý chính: servo; góc; PWM; cơ cấu chấp hành; giới hạn cơ khí.
...
micro:bit, bo Crowtail, servo, bìa carton. Chuẩn bị thêm giấy A4, bút, thước, nhật ký kỹ thuật và vật liệu chế tạo nếu cần.
...
**Câu hỏi suy nghĩ:** Thêm trạng thái mở một nửa và chuyển động từng bước để cửa chạy êm.

## 4. Kiến thức cốt lõi — 15 phút

- Từ khóa: servo; góc; PWM; cơ cấu chấp hành; giới hạn cơ khí.
...
```text
set closed=10; set open=90; A → servo open; B → servo closed
```
...
6. **Lưu phiên bản:** đặt tên tệp `Lop_Nhom_Bai08_v1` và chụp sơ đồ kết nối.

### Tiêu chí thành công

- [ ] cửa mở/đóng đúng hai góc và không bị kẹt.
...
- Phản tư cá nhân 3–5 câu và tên phiên bản cuối `Lop_Nhom_Bai08_final`.
