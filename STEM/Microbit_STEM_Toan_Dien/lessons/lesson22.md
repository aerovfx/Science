# Bài 22: Chuỗi và thông điệp dữ liệu

> **Câu hỏi lớn:** Thiết bị tạo và giải mã thông điệp có cấu trúc như thế nào?  
> **Sản phẩm:** Biển tên kèm dữ liệu cảm biến  
...
1. Giải thích các ý chính: string; nối chuỗi; độ dài; chuyển số thành chữ; định dạng.
...
**Câu hỏi suy nghĩ:** Giải thích vì sao dấu phân cách giúp máy khác đọc thông điệp dễ hơn.

## 4. Kiến thức cốt lõi — 15 phút

- Từ khóa: string; nối chuỗi; độ dài; chuyển số thành chữ; định dạng.
...
```text
message = ID + ":" + value + ":C"; scroll message
```
...
6. **Lưu phiên bản:** đặt tên tệp `Lop_Nhom_Bai22_v1` và chụp sơ đồ kết nối.

### Tiêu chí thành công

- [ ] tạo thông điệp gồm ID, giá trị và đơn vị, hiển thị đúng.
...
- Phản tư cá nhân 3–5 câu và tên phiên bản cuối `Lop_Nhom_Bai22_final`.
