# Buổi 5: HC-SR04 và đo khoảng cách

> **Câu hỏi lớn:** Có thể suy ra khoảng cách từ thời gian phản xạ âm thanh không?  
> **Sản phẩm:** Thước đo điện tử có cảnh báo vùng  
...
1. Giải thích: time-of-flight; pulse_us; vận tốc âm; timeout; sai số.
...
**Thiết bị:** Pico, HC-SR04/module siêu âm, bộ chia áp hoặc level shifter nếu cần, buzzer/LCD.
...
**Từ khóa:** time-of-flight; pulse_us; vận tốc âm; timeout; sai số.
...
5. Lưu phiên bản `Lop_Nhom_Pico_Bai05_v1.py`.

## 7. Thử thách chế tạo — 35 phút

Hoàn thiện **Thước đo điện tử có cảnh báo vùng**. Sản phẩm phải có chức năng chính, trạng thái chờ, trạng thái lỗi và cách dừng/reset an toàn. Nhóm tự chọn một cải tiến phục vụ người dùng thay vì chỉ trang trí.
...
**Yêu cầu riêng:** so với thước tại 10, 30, 60 cm; tính sai số; thử không có vật.
...
Mã nguồn, bảng chân, ảnh mạch, bảng kiểm thử, ảnh/video demo và phản tư cá nhân. Tên bản cuối: `Lop_Nhom_Pico_Bai05_final.py`.
