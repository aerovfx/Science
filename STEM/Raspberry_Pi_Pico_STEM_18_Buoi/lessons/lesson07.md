# Buổi 7: Cảm biến mưa, lửa và hệ thống cảnh báo

> **Câu hỏi lớn:** Kết hợp cảm biến thế nào để cảnh báo nhanh nhưng ít báo giả?  
> **Sản phẩm:** Bảng cảnh báo môi trường ba mức  
...
1. Giải thích: digital/analog input; AND/OR; alarm state; sensor fusion; fail-safe.
...
**Thiết bị:** Pico, rain sensor, flame sensor, RGB LED, buzzer.
...
**Từ khóa:** digital/analog input; AND/OR; alarm state; sensor fusion; fail-safe.
...
5. Lưu phiên bản `Lop_Nhom_Pico_Bai07_v1.py`.

## 7. Thử thách chế tạo — 35 phút

Hoàn thiện **Bảng cảnh báo môi trường ba mức**. Sản phẩm phải có chức năng chính, trạng thái chờ, trạng thái lỗi và cách dừng/reset an toàn. Nhóm tự chọn một cải tiến phục vụ người dùng thay vì chỉ trang trí.
...
**Yêu cầu riêng:** ma trận bốn tổ hợp mưa/không mưa × lửa/không lửa; kiểm tra dây cảm biến rời.
...
Mã nguồn, bảng chân, ảnh mạch, bảng kiểm thử, ảnh/video demo và phản tư cá nhân. Tên bản cuối: `Lop_Nhom_Pico_Bai07_final.py`.
