# Buổi 1: Raspberry Pi Pico, GPIO, LED và nút nhấn

> **Câu hỏi lớn:** Làm sao một chân GPIO vừa nhận lệnh vừa điều khiển thế giới vật lý?  
> **Sản phẩm:** Đèn SOS và công tắc LED  
...
1. Giải thích: MicroPython; Pin.OUT; Pin.IN; pull-up; active-high/active-low; debounce.
...
**Thiết bị:** Pico, LED module, push button, điện trở/module phù hợp.
...
**Từ khóa:** MicroPython; Pin.OUT; Pin.IN; pull-up; active-high/active-low; debounce.
...
5. Lưu phiên bản `Lop_Nhom_Pico_Bai01_v1.py`.

## 7. Thử thách chế tạo — 35 phút

Hoàn thiện **Đèn SOS và công tắc LED**. Sản phẩm phải có chức năng chính, trạng thái chờ, trạng thái lỗi và cách dừng/reset an toàn. Nhóm tự chọn một cải tiến phục vụ người dùng thay vì chỉ trang trí.
...
**Yêu cầu riêng:** nút nhấn/nhả 20 lần; LED SOS đúng ba ngắn–ba dài–ba ngắn.
...
Mã nguồn, bảng chân, ảnh mạch, bảng kiểm thử, ảnh/video demo và phản tư cá nhân. Tên bản cuối: `Lop_Nhom_Pico_Bai01_final.py`.
