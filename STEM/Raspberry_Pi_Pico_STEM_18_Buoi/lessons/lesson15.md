# Buổi 15: Dự án nhà thông minh

> **Câu hỏi lớn:** Tự động hóa nhà ở thế nào để tiện nghi nhưng vẫn an toàn và tiết kiệm?  
> **Sản phẩm:** Mô hình phòng có chế độ AUTO/MANUAL  
...
1. Giải thích: system integration; mode; threshold; UI; energy; state machine.
...
**Thiết bị:** Pico, DHT11, light sensor, LCD, LED/RGB, button hoặc keypad.
...
**Từ khóa:** system integration; mode; threshold; UI; energy; state machine.
...
```python
# AUTO: đọc ánh sáng và nhiệt độ; điều khiển đèn/cảnh báo
...
5. Lưu phiên bản `Lop_Nhom_Pico_Bai15_v1.py`.

## 7. Thử thách chế tạo — 35 phút

Hoàn thiện **Mô hình phòng có chế độ AUTO/MANUAL**. Sản phẩm phải có chức năng chính, trạng thái chờ, trạng thái lỗi và cách dừng/reset an toàn. Nhóm tự chọn một cải tiến phục vụ người dùng thay vì chỉ trang trí.
...
**Yêu cầu riêng:** ngày/đêm × nóng/bình thường × AUTO/MANUAL; ghi tối thiểu 8 ca.
...
Mã nguồn, bảng chân, ảnh mạch, bảng kiểm thử, ảnh/video demo và phản tư cá nhân. Tên bản cuối: `Lop_Nhom_Pico_Bai15_final.py`.
