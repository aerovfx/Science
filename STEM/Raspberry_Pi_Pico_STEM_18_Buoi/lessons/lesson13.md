# Buổi 13: Robot dò line

> **Câu hỏi lớn:** Phản xạ hồng ngoại giúp robot nhìn thấy đường như thế nào?  
> **Sản phẩm:** Xe bám vạch có hiệu chuẩn  
...
1. Giải thích: reflectance; calibration; threshold; left/right correction; control loop.
...
**Thiết bị:** robot xe, line tracking sensors, đường thử đen–trắng.
...
**Từ khóa:** reflectance; calibration; threshold; left/right correction; control loop.
...
```python
def drive_from_line(left,right):
...
5. Lưu phiên bản `Lop_Nhom_Pico_Bai13_v1.py`.

## 7. Thử thách chế tạo — 35 phút

Hoàn thiện **Xe bám vạch có hiệu chuẩn**. Sản phẩm phải có chức năng chính, trạng thái chờ, trạng thái lỗi và cách dừng/reset an toàn. Nhóm tự chọn một cải tiến phục vụ người dùng thay vì chỉ trang trí.
...
**Yêu cầu riêng:** đo trắng/đen; đường thẳng, cua trái, cua phải; hai vòng không rời vạch.
...
Mã nguồn, bảng chân, ảnh mạch, bảng kiểm thử, ảnh/video demo và phản tư cá nhân. Tên bản cuối: `Lop_Nhom_Pico_Bai13_final.py`.
