# Buổi 12: Robot tránh vật cản

> **Câu hỏi lớn:** Robot dùng vòng phản hồi để tự thay đổi hành vi thế nào?  
> **Sản phẩm:** Xe tự tránh vật cản  
...
1. Giải thích: feedback loop; threshold; state machine; scan; recovery.
...
**Thiết bị:** robot xe, HC-SR04, servo tùy chọn.
...
**Từ khóa:** feedback loop; threshold; state machine; scan; recovery.
...
5. Lưu phiên bản `Lop_Nhom_Pico_Bai12_v1.py`.

## 7. Thử thách chế tạo — 35 phút

Hoàn thiện **Xe tự tránh vật cản**. Sản phẩm phải có chức năng chính, trạng thái chờ, trạng thái lỗi và cách dừng/reset an toàn. Nhóm tự chọn một cải tiến phục vụ người dùng thay vì chỉ trang trí.
...
**Yêu cầu riêng:** ba vật liệu/kích thước vật; ba lần đường thử; thử sensor timeout.
...
Mã nguồn, bảng chân, ảnh mạch, bảng kiểm thử, ảnh/video demo và phản tư cá nhân. Tên bản cuối: `Lop_Nhom_Pico_Bai12_final.py`.
