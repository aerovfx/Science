# Buổi 18: Đồ án cuối khóa và bảo vệ

> **Câu hỏi lớn:** Bằng chứng nào cho thấy sản phẩm giải quyết được vấn đề thật?  
> **Sản phẩm:** Sản phẩm hoàn chỉnh theo lựa chọn nhóm  
...
1. Giải thích: design thinking; requirement; architecture; risk; test; iteration; communication.
...
**Thiết bị:** các module được giáo viên duyệt; vật liệu tạo mẫu; poster/slide.
...
**Từ khóa:** design thinking; requirement; architecture; risk; test; iteration; communication.
...
5. Lưu phiên bản `Lop_Nhom_Pico_Bai18_v1.py`.

## 7. Thử thách chế tạo — 35 phút

Hoàn thiện **Sản phẩm hoàn chỉnh theo lựa chọn nhóm**. Sản phẩm phải có chức năng chính, trạng thái chờ, trạng thái lỗi và cách dừng/reset an toàn. Nhóm tự chọn một cải tiến phục vụ người dùng thay vì chỉ trang trí.
...
**Yêu cầu riêng:** ≥5 ca kiểm thử gồm bình thường, biên và lỗi; một cải tiến dựa dữ liệu.
...
Mã nguồn, bảng chân, ảnh mạch, bảng kiểm thử, ảnh/video demo và phản tư cá nhân. Tên bản cuối: `Lop_Nhom_Pico_Bai18_final.py`.
