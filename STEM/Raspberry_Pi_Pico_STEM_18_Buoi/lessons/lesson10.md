# Buổi 10: DC motor, motor driver và xe cơ bản

> **Câu hỏi lớn:** Vì sao vi điều khiển cần driver để điều khiển động cơ?  
> **Sản phẩm:** Xe chạy tiến–lùi–rẽ–dừng  
...
1. Giải thích: H-bridge; direction; PWM speed; common ground; emergency stop.
...
**Thiết bị:** Pico, chassis, hai DC motor, motor driver, nguồn pin.
...
**Từ khóa:** H-bridge; direction; PWM speed; common ground; emergency stop.
...
5. Lưu phiên bản `Lop_Nhom_Pico_Bai10_v1.py`.

## 7. Thử thách chế tạo — 35 phút

Hoàn thiện **Xe chạy tiến–lùi–rẽ–dừng**. Sản phẩm phải có chức năng chính, trạng thái chờ, trạng thái lỗi và cách dừng/reset an toàn. Nhóm tự chọn một cải tiến phục vụ người dùng thay vì chỉ trang trí.
...
**Yêu cầu riêng:** kê bánh và thử từng motor; tiến/lùi/dừng; kiểm tra nhiệt driver và hướng bánh.
...
Mã nguồn, bảng chân, ảnh mạch, bảng kiểm thử, ảnh/video demo và phản tư cá nhân. Tên bản cuối: `Lop_Nhom_Pico_Bai10_final.py`.
