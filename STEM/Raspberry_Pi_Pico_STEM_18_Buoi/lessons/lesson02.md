# Buổi 2: PWM, RGB LED và buzzer

> **Câu hỏi lớn:** Tín hiệu bật–tắt rất nhanh tạo độ sáng, màu và âm như thế nào?  
> **Sản phẩm:** Đèn giao thông và piano mini  
...
1. Giải thích: PWM; tần số; duty cycle; RGB; tone.
...
**Thiết bị:** Pico, RGB LED/traffic light, buzzer.
...
**Từ khóa:** PWM; tần số; duty cycle; RGB; tone.
...
5. Lưu phiên bản `Lop_Nhom_Pico_Bai02_v1.py`.

## 7. Thử thách chế tạo — 35 phút

Hoàn thiện **Đèn giao thông và piano mini**. Sản phẩm phải có chức năng chính, trạng thái chờ, trạng thái lỗi và cách dừng/reset an toàn. Nhóm tự chọn một cải tiến phục vụ người dùng thay vì chỉ trang trí.
...
**Yêu cầu riêng:** đo/quan sát bốn mức sáng; bốn màu; bốn nốt phân biệt.
...
Mã nguồn, bảng chân, ảnh mạch, bảng kiểm thử, ảnh/video demo và phản tư cá nhân. Tên bản cuối: `Lop_Nhom_Pico_Bai02_final.py`.
