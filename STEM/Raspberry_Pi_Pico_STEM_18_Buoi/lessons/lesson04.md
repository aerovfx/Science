# Buổi 4: LCD1602 và giao tiếp I2C

> **Câu hỏi lớn:** Nhiều thiết bị có thể dùng chung hai dây giao tiếp như thế nào?  
> **Sản phẩm:** Màn hình thông số và menu hai trang  
...
1. Giải thích: I2C; SDA/SCL; address; scan; driver; user interface.
...
**Thiết bị:** Pico, LCD1602 I2C, button/rotary encoder.
...
**Từ khóa:** I2C; SDA/SCL; address; scan; driver; user interface.
...
5. Lưu phiên bản `Lop_Nhom_Pico_Bai04_v1.py`.

## 7. Thử thách chế tạo — 35 phút

Hoàn thiện **Màn hình thông số và menu hai trang**. Sản phẩm phải có chức năng chính, trạng thái chờ, trạng thái lỗi và cách dừng/reset an toàn. Nhóm tự chọn một cải tiến phục vụ người dùng thay vì chỉ trang trí.
...
**Yêu cầu riêng:** quét thấy địa chỉ; hiển thị đủ 16×2; đổi menu không nhấp nháy quá mức.
...
Mã nguồn, bảng chân, ảnh mạch, bảng kiểm thử, ảnh/video demo và phản tư cá nhân. Tên bản cuối: `Lop_Nhom_Pico_Bai04_final.py`.
